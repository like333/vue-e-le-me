			...
			<div v-show="showFlag" class="food" ref="food">
				<div class="food-content">
					...
					<div class="rating">
						...
						@toggleContent = "toggleCon"
						 :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></RatingSelect>
					</div>
							...
							<li v-show="needShow(rating.rateType,rating.text)" v-for="rating in food.ratings" :key="rating.id" class="rating-item border-1px">
								<div class="user">
									<span class="name">{{rating.username}}
										<img width="12" height="12" :src="rating.avatar" :alt="rating.username">
									</span>
								</div>
